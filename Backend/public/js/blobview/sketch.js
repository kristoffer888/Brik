...
function setup() {
  ...
  setInterval(function() {
      console.log(getFromZone(1));
      console.log(getFromZone(2));
      console.log(getFromZone(3));
      console.log(getFromZone(4));
      console.log(getFromZone(5));
      console.log(getFromZone(6));
  }, 1000);
  zones[0].init();
  zones[1].init();
  zones[2].init();
